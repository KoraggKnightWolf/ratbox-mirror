...
+-----------------------------------------------------------------------------+
    ...
    I. ./configure 
        ( ./configure --prefix /home/user/ircd is no longer needed as the default prefix has been changed to $HOME/ircd
          see [here](https://github.com/KoraggKnightWolf/ratbox-mirror/commit/a9030749ac52897daaf601baa43a80ba7653137b) )
    ...
    II. Configure ircd-ratbox for running with minimal resources on a 64bit VPS.
        This creates a 32bit IRCD which takes up less memory:
          ...
          (as above, specifying the prefix to /home/user/ircd is no longer necessary)
