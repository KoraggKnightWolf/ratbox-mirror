...
#define NUMERIC_STR_212 "%s %u %u :%u"
...
#define NUMERIC_STR_250 ":Highest connection count: %d (%d clients) (%d connections received)"
...
#define NUMERIC_STR_254 "%d :channels formed"
...
#define NUMERIC_STR_322 ":%s 322 %s %s %d :%s"
