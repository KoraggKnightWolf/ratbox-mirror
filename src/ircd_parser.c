...
{
       0,   178,   178,   179,   180,   183,   184,   188,   187,   197,
     196,   207,   208,   211,   219,   220,   223,   227,   248,   254,
     260,   266,   289,   288,   297,   298,   299,   301,   313,   317
};
#endif
...
#line 228 "src/ircd_parser.y"
  ...
  case 18:
#line 249 "src/ircd_parser.y"
    {
		(yyval.conf_parm) = ircd_malloc(sizeof(conf_parm_t));
		(yyval.conf_parm)->type = CF_QSTRING;
		(yyval.conf_parm)->v.string = ircd_strdup((yyvsp[0].string));
	    }
    break;

  case 19:
#line 255 "src/ircd_parser.y"
    {
		(yyval.conf_parm) = ircd_malloc(sizeof(conf_parm_t));
...
#line 297 "src/ircd_parser.y"
  ...
  case 25:
#line 298 "src/ircd_parser.y"
    { strcpy((yyval.string), (yyvsp[0].string)); }
    break;

  case 26:
#line 299 "src/ircd_parser.y"
